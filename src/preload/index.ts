...
const realApi = {
  ...
  rocketLeague: {
    ...
    esportsEvents: () => ipcRenderer.invoke('rl:esports-events'),
    esportsPlayers: () => ipcRenderer.invoke('rl:esports-players'),
    twitchLive: (logins: string[]) => ipcRenderer.invoke('rl:twitch-live', logins),
